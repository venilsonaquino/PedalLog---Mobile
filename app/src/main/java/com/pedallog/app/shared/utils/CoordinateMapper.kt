...
class CoordinateMapper(
    ...
    private val minLat = points.minOf { it.coordinate.latitude }
    private val minLon = points.minOf { it.coordinate.longitude }
    private val scale: Double

    init {
        val latRange = points.maxOf { it.coordinate.latitude } - minLat
        val lonRange = points.maxOf { it.coordinate.longitude } - minLon
